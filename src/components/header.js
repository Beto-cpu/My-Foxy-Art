...
export default function Header() {
  ...
  return (
    <div className="p-5 mb-5 sm:mb-0">
      ...
      <div className={`z-10 flex flex-col items-center fixed h-screen bg-anemia-yellow px-10 py-7 text-xl transition-all duration-300 top-0 ${isMenuOpen? 'right-0' : '-right-64'}`}>
        <button className="absolute right-8 hover:text-red-500" onClick={closeMenuHandler}>
